...
namespace Quantum {
  ...
  public unsafe partial class Frame {
    ...
    public MapCustomData FindAsset(AssetRefMapCustomData assetRef) {
         return this.FindAsset<MapCustomData>(assetRef.Id);
    }
    ...
    public unsafe partial struct FrameAssets {
      ...
      public MapCustomData MapCustomData(AssetRefMapCustomData assetRef) {
         return _f.FindAsset<MapCustomData>(assetRef.Id);
      }
      [System.ObsoleteAttribute("Use Frame.FindAsset instead")]
  ...
  [StructLayout(LayoutKind.Explicit)]
  [Quantum.AssetRefAttribute(typeof(MapCustomData))]
  [System.SerializableAttribute()]
  [System.ObsoleteAttribute("Use AssetRef<Quantum.MapCustomData> instead")]
  public unsafe partial struct AssetRefMapCustomData : System.IEquatable<AssetRefMapCustomData>, IAssetRef<MapCustomData> {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public AssetGuid Id;
    public AssetRefMapCustomData(AssetGuid value) {
      Id = value;
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (AssetRefMapCustomData*)ptr;
        AssetGuid.Serialize(&p->Id, serializer);
    }
    public override String ToString() {
      return AssetRef.ToString(Id);
    }
    public static implicit operator AssetRefMapCustomData(MapCustomData value) {
      var r = default(AssetRefMapCustomData);
      if (value != null) {
        r.Id = value.Guid;
      }
      return r;
    }
    public static explicit operator AssetRefMapCustomData(AssetRef value) {
      return new AssetRefMapCustomData { Id = value.Id };
    }
    public static implicit operator AssetRef(AssetRefMapCustomData value) {
      return new AssetRef(value.Id);
    }
    public static implicit operator AssetRef<MapCustomData>(AssetRefMapCustomData value) {
      return new AssetRef<MapCustomData>(value.Id);
    }
    public static implicit operator AssetRefMapCustomData(AssetRef<MapCustomData> value) {
      return new AssetRefMapCustomData(value.Id);
    }
    public override Boolean Equals(Object obj) {
      return obj is AssetRefMapCustomData other && Equals(other);
    }
    public Boolean Equals(AssetRefMapCustomData other) {
      return Id.Equals(other.Id);
    }
    public static Boolean operator ==(AssetRefMapCustomData a, AssetRefMapCustomData b) {
      return a.Id == b.Id;
    }
    public static Boolean operator !=(AssetRefMapCustomData a, AssetRefMapCustomData b) {
      return a.Id != b.Id;
  ...
  public static unsafe partial class BitStreamExtensions {
    ...
    [System.ObsoleteAttribute("No longer needed")]
    public static void Serialize(this IBitStream stream, ref AssetRefMapCustomData value) {
      stream.Serialize(ref value.Id.Value);
    }
    [System.ObsoleteAttribute("No longer needed")]
  ...
  public unsafe partial class Statics {
    static partial void RegisterLegacySimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.AssetRefMapCustomData), Quantum.AssetRefMapCustomData.SIZE);
